...
var rand = function(){
	return Math.floor(Math.random() * 100) + 550;
}
...
var data1 = {
  labels : ["10:10","10:20","10:30","10:40","10:50","11:00","11:10","11:20","11:30","11:40"],
  datasets : [
    {
      fillColor : "rgba(51,136,153,.2)",
      strokeColor : "#389",
      pointColor : "#aee",
      pointStrokeColor : "#389",
